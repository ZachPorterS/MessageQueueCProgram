 ...
 */
 ...
 struct msg_queue {
	struct mq_msg messages[QUEUE_SIZE]; // array of structures to store msgs
	unsigned int in; // number of messages sent
	unsigned int out; // number of message recieved
	pthread_mutex_t lock; // guards
